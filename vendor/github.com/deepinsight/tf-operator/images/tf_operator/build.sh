...
GOOS=linux GOARCH=amd64 go install github.com/deepinsight/tf-operator/cmd/tf_operator
GOOS=linux GOARCH=amd64 go install github.com/deepinsight/tf-operator/test/e2e
cp ${GOPATH}/bin/linux_amd64/tf_operator ${DIR}/
cp ${GOPATH}/bin/linux_amd64/e2e ${DIR}/
cp ./images/tf_operator/Dockerfile ${DIR}/
