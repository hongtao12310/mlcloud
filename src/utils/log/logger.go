...
//SetSkipLine sets the skip line of Logger l
func (l *Logger) SetSkipLine(skip bool) Level {
    l.mu.Lock()
    defer l.mu.Unlock()
...
//GetSkipLine get the skip line of Logger l
func (l *Logger) GetSkipLine() bool {
    return l.skipLine
}
